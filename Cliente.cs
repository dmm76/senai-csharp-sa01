...
namespace CRUD
{
    public class Cliente
    {
        ...
        SqlConnection con = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\SENAI_APP\\SA1\\Primeira Aula\\CRUD\\DbCliente.mdf;Integrated Security=True");
